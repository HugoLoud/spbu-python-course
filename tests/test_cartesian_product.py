...
def test_cartesian_product_complex_case():
    ...
    # Manually calculated result: 1500 + 1600 + 1600 + 1700 + 1600 + 1700 = 9700
    assert result == 9700
...
def test_cartesian_product_with_negative_and_large_numbers():
    ...
    # Manually calculated result: -3000 + 8000 - 10000 + 1000 - 2000 + 11000 = 7000
    assert result == 7000
...
def test_cartesian_product_with_large_list_sizes():
    ...
    """
    lists = [[i for i in range(100, 201, 50)], [j for j in range(500, 1001, 250)], [k for k in range(2000, 4001, 1000)]]
    result = cartesian_product_sum(lists)
    ...
    expected_result = 1980000  # Pre-calculated manually.
